                ...
                <div class="col-lg-12">
                    ...
                    <div class="comon-slider owl-carousel">
                        <div class="slider-item">
                            <img src="{{ asset('storage/image/Automation-1.jpg') }}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{ asset('storage/image/Automation-2.jpg') }}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{ asset('storage/image/Automation-3.jpg') }}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{ asset('storage/image/Automation-4.jpg') }}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{ asset('storage/image/Automation-6.jpg') }}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{ asset('storage/image/Automation-5.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
