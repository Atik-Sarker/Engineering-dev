            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="comon-slider owl-carousel">
                        ...
                        <img src="{{asset('storage/image/construction-1.jpg')}}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{asset('storage/image/construction-2.jpg')}}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{asset('storage/image/construction-3.jpg')}}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{asset('storage/image/construction-4.jpg')}}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{asset('storage/image/construction-5.jpg')}}" alt="">
                        </div>
                        <div class="slider-item">
                            <img src="{{asset('storage/image/construction-6.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
